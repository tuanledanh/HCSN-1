        ...
        <form class="t-popup" ref="form" @keyup.esc="showToast">
            ...
            <main class="t-popup__header--body edit__body">
                ...
                <m-input
                    ...
                    :label="labelForm.StartUsingDate"
...
export default {
    ...
    methods: {
        ...
        validate() {
            ...
            if (this.FixedAssetCategoryCode === '') {
                hasMissingFields = true
                missingFields += this.labelForm.FixedAssetCategoryCode
                if (fieldToFocus === null) {
                    fieldToFocus = 'fixedAssetCategoryCode'
                }
            }
            ...
            let dateStartUsingDate = new Date(this.StartUsingDate)
            if (dateStartUsingDate < datePurchaseDate) {
                this.isShowToastValidate = true
                this.inputFocus = 'StartUsingDate'
                this.messageValidate = this.contentValidate.StartUsingDatePurchaseDate
                this.isValidate = false
                return
            }
        },
            ...
            if (this.isValidate) {
                if (!this.isShowToastValidateData && !this.isShowToastValidate) {
                    let newFixedAsset = {
                        ...
                        StartUsingDate: new Date(this.StartUsingDate).toISOString(),
    ...
    computed: {
        ...
        isUpdate() {
            ...
            t = t || this.convertDate(this.fixedAsset.StartUsingDate) !== this.StartUsingDate
    ...
    mounted() {
        ...
        if (this.action === 'create') {
            ...
            this.StartUsingDate = `${year}-${month}-${day}`
        }
        // Update FixedAsset
        else {
